            ...
            HStack{
                ...
                Button {
                    if selectedFirstImage != nil && selectedImage != nil {
                        let url = sendAPIPostRequest(firstImage: selectedFirstImage!, secondImage: selectedImage!)
                        print(url)
//                        outputUrl = String(describing: url)
//                        loadImage(for: outputUrl)
...
//                        VideoPlayer(player: AVPlayer(url: selectedMedia!))
        ...
        .sheet(isPresented: $isShowingPicker1){
            mediaPicker(selectedMedia: .constant(nil), selectedImage: $selectedFirstImage, isShowingPicker: $isShowingPicker1)
        }
        .sheet(isPresented: $isShowingPicker2){
            mediaPicker(selectedMedia: $selectedMedia, selectedImage: $selectedImage, isShowingPicker: $isShowingPicker2)
        }
    }
...
func sendAPIPostRequest(firstImage:UIImage, secondImage: UIImage) -> Void {
